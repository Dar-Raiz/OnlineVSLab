...
function SetupConstantsRoutineBegin(snapshot) {
  return async function () {
    ...
    SetupConstantsComponents.forEach( function(thisComponent) {
...
function Instruct1aRoutineBegin(snapshot) {
  return async function () {
    ...
    Instruct1aComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruct1bRoutineBegin(snapshot) {
  return async function () {
    ...
    Instruct1bComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function StudyView1RoutineBegin(snapshot) {
  return async function () {
    ...
    StudyView1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ShowRespRoutineBegin(snapshot) {
  return async function () {
    ...
    ShowRespComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Fbk1RoutineBegin(snapshot) {
  return async function () {
    ...
    Fbk1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EndPart1RoutineBegin(snapshot) {
  return async function () {
    ...
    EndPart1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruct4_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Instruct4_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function StudyView4RoutineBegin(snapshot) {
  return async function () {
    ...
    StudyView4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ChooseFbkRoutineBegin(snapshot) {
  return async function () {
    ...
    ChooseFbkComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Fbk2RoutineBegin(snapshot) {
  return async function () {
    ...
    Fbk2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EndPart2RoutineBegin(snapshot) {
  return async function () {
    ...
    EndPart2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Instruct3aRoutineBegin(snapshot) {
  return async function () {
    ...
    Instruct3aComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ShowResp_3RoutineBegin(snapshot) {
  return async function () {
    ...
    ShowResp_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function AdditupRoutineBegin(snapshot) {
  return async function () {
    ...
    AdditupComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EndPart3RoutineBegin(snapshot) {
  return async function () {
    ...
    EndPart3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
